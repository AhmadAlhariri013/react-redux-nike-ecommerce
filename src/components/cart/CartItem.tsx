...
const CartItem: React.FC<ICartItemState> = ({
  items: { id, title, text, img, color, shadow, price, cartQuantity },
  isWishlist,
}) => {
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="grid items-center gap-4">
            ...
            {!isWishlist ? (
              ...
              <button
                type="button"
                className="bg-slate-900 blur-effect-theme button-theme px-2 py-1 shadow shadow-sky-200 text-sm text-white"
                onClick={() => {
                  onAddToCart();
                  onCartToggle();
                }}
